...
public class SimpleBSTree<T extends Comparable<? super T>> extends BinaryTree<T> implements DefaultBSTree<T> {
    ...
    public SimpleBSTree(Function<String, T> fromStrFunc, Function<T, String> toStrFunc) throws Exception {
        super(fromStrFunc, toStrFunc);
    }

    public SimpleBSTree(Function<String, T> fromStrFunc) throws Exception {
        super(fromStrFunc);
    }

    public SimpleBSTree() throws Exception {
        super();
    }
